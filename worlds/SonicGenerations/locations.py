...
LOCATION_NAME_TO_ID = {
    ...
    names.Locations.ClearBMS:   106,
    names.Locations.ClearBDE:   107,
    names.Locations.ClearSPH1:  108,
    names.Locations.ClearSPH2:  109,
    names.Locations.ClearCTE1:  110,
    names.Locations.ClearCTE2:  111,
    names.Locations.ClearSSH1:  112,
    names.Locations.ClearSSH2:  113,
    names.Locations.ClearBSD:   114,
    names.Locations.ClearBPC:   115,
    names.Locations.ClearCSC1:  116,
    names.Locations.ClearCSC2:  117,
    names.Locations.ClearEUC1:  118,
    names.Locations.ClearEUC2:  119,
    names.Locations.ClearPLA1:  120,
    names.Locations.ClearPLA2:  121,
    names.Locations.ClearBSL:   122,
